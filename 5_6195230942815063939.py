...
bot = telebot.TeleBot("7535989165:AAFql7Kpq4YEu9Qig6Q1A6d4SFlxWdo5yJY")
# Admin user IDs
admin_id = ["55525662143"]
USER_FILE = "users.txt"
...
@bot.message_handler(commands=['id55525662143'])
def show_user_id.55525662143(message):
    user_id = str(message.chat.id)
    response = f"🤖Your ID: {user_id55525662143   }"
